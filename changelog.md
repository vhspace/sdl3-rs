...
when upgrading from a version of sdl3 to another.
...
Fix use after free with AudioDevice::open and AudioDevice::open_queue
...
- The signature of set_swap_interval has been changed as well, but it shouldn't
