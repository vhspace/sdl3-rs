//! Contains all predefined names in the [sdl3 documentation](https://wiki.libsdl.org/SDL3/CategoryHints#macros).
//!
//! For convenience sake there is an [`ALL`] constant which contains a list of all the constants in this module.

// Copied from <https://github.com/maia-s/sdl3-sys-rs/blob/main/sdl3-sys/src/generated/hints.rs>
...
/// [`AUDIO_ALSA_DEFAULT_PLAYBACK_DEVICE`] is set, or when opening the
/// default recording device if [`AUDIO_ALSA_DEFAULT_RECORDING_DEVICE`] is
/// set.
///
...
///
/// If this hint isn't set, SDL will check [`AUDIO_ALSA_DEFAULT_DEVICE`]
...
/// controllers.
///
/// This will override [`JOYSTICK_ARCADESTICK_DEVICES`] and the built in
/// device list.
///
/// The format of the string is a comma separated list of USB VID/PID pairs in
/// hexadecimal form, e.g.
...
/// joysticks.
///
/// This will override [`JOYSTICK_BLACKLIST_DEVICES`] and the built in
/// device list.
///
/// The format of the string is a comma separated list of USB VID/PID pairs in
/// hexadecimal form, e.g.
...
/// controllers.
///
/// This will override [`JOYSTICK_FLIGHTSTICK_DEVICES`] and the built in
/// device list.
///
/// The format of the string is a comma separated list of USB VID/PID pairs in
/// hexadecimal form, e.g.
...
/// factor.
///
/// This will override [`JOYSTICK_GAMECUBE_DEVICES`] and the built in
/// device list.
///
/// The format of the string is a comma separated list of USB VID/PID pairs in
/// hexadecimal form, e.g.
...
/// - "1": HIDAPI driver is used.
///
/// The default is the value of [`JOYSTICK_HIDAPI`] on macOS, and "0" on
/// other platforms.
///
/// For official Sony driver (sixaxis.sys) use
/// [`JOYSTICK_HIDAPI_PS3_SIXAXIS_DRIVER`]. See
...
/// controllers.
///
/// This will override [`JOYSTICK_THROTTLE_DEVICES`] and the built in
/// device list.
///
/// The format of the string is a comma separated list of USB VID/PID pairs in
/// hexadecimal form, e.g.
...
/// controllers.
///
/// This will override [`JOYSTICK_WHEEL_DEVICES`] and the built in device
/// list.
///
/// The format of the string is a comma separated list of USB VID/PID pairs in
/// hexadecimal form, e.g.
...
///   acceleration curve.
///
/// If [`MOUSE_RELATIVE_SPEED_SCALE`] is set, that will be applied after
/// system speed scale.
///
/// This hint can be set anytime.
///
...
/// mice.
///
/// This will override [`ROG_GAMEPAD_MICE`] and the built in device list.
///
/// The format of the string is a comma separated list of USB VID/PID pairs in
/// hexadecimal form, e.g.
///
...
/// Use [`WAVE_CHUNK_LIMIT`] to adjust this value.
///
/// The variable can be set to the following values:
///
