...
pub enum PixelFormatEnum {
    Unknown = SDL_PIXELFORMAT_UNKNOWN as isize,
    Index1LSB = SDL_PIXELFORMAT_INDEX1LSB as isize,
    Index1MSB = SDL_PIXELFORMAT_INDEX1MSB as isize,
    Index4LSB = SDL_PIXELFORMAT_INDEX4LSB as isize,
    Index4MSB = SDL_PIXELFORMAT_INDEX4MSB as isize,
    Index8 = SDL_PIXELFORMAT_INDEX8 as isize,
    RGB332 = SDL_PIXELFORMAT_RGB332 as isize,
    RGB444 = SDL_PIXELFORMAT_RGB444 as isize,
    RGB555 = SDL_PIXELFORMAT_RGB555 as isize,
    BGR555 = SDL_PIXELFORMAT_BGR555 as isize,
    ARGB4444 = SDL_PIXELFORMAT_ARGB4444 as isize,
    RGBA4444 = SDL_PIXELFORMAT_RGBA4444 as isize,
    ABGR4444 = SDL_PIXELFORMAT_ABGR4444 as isize,
    BGRA4444 = SDL_PIXELFORMAT_BGRA4444 as isize,
    ARGB1555 = SDL_PIXELFORMAT_ARGB1555 as isize,
    RGBA5551 = SDL_PIXELFORMAT_RGBA5551 as isize,
    ABGR1555 = SDL_PIXELFORMAT_ABGR1555 as isize,
    BGRA5551 = SDL_PIXELFORMAT_BGRA5551 as isize,
    RGB565 = SDL_PIXELFORMAT_RGB565 as isize,
    BGR565 = SDL_PIXELFORMAT_BGR565 as isize,
    RGB24 = SDL_PIXELFORMAT_RGB24 as isize,
    BGR24 = SDL_PIXELFORMAT_BGR24 as isize,
    RGB888 = SDL_PIXELFORMAT_RGB888 as isize,
    RGBX8888 = SDL_PIXELFORMAT_RGBX8888 as isize,
    BGR888 = SDL_PIXELFORMAT_BGR888 as isize,
    BGRX8888 = SDL_PIXELFORMAT_BGRX8888 as isize,
    ARGB8888 = SDL_PIXELFORMAT_ARGB8888 as isize,
    RGBA8888 = SDL_PIXELFORMAT_RGBA8888 as isize,
    ABGR8888 = SDL_PIXELFORMAT_ABGR8888 as isize,
    BGRA8888 = SDL_PIXELFORMAT_BGRA8888 as isize,
    ARGB2101010 = SDL_PIXELFORMAT_ARGB2101010 as isize,
    ABGR16161616 = SDL_PIXELFORMAT_ABGR16161616 as isize,
    ABGR16161616F = SDL_PIXELFORMAT_ABGR16161616F as isize,
    NV12 = SDL_PIXELFORMAT_NV12 as isize,
    NV21 = SDL_PIXELFORMAT_NV21 as isize,
    YV12 = SDL_PIXELFORMAT_YV12 as isize,
    IYUV = SDL_PIXELFORMAT_IYUV as isize,
    YUY2 = SDL_PIXELFORMAT_YUY2 as isize,
    UYVY = SDL_PIXELFORMAT_UYVY as isize,
    YVYU = SDL_PIXELFORMAT_YVYU as isize,
}
...
impl TryFrom<PixelFormat> for PixelFormatEnum {
    ...
    fn try_from(value: PixelFormat) -> Result<Self, Self::Error> {
        match value.raw.0 {
            ...
            SDL_PIXELFORMAT_RGB444 => Ok(PixelFormatEnum::RGB444),
            SDL_PIXELFORMAT_RGB555 => Ok(PixelFormatEnum::RGB555),
            SDL_PIXELFORMAT_BGR555 => Ok(PixelFormatEnum::BGR555),
            ...
            SDL_PIXELFORMAT_RGB888 => Ok(PixelFormatEnum::RGB888),
            SDL_PIXELFORMAT_RGBX8888 => Ok(PixelFormatEnum::RGBX8888),
            SDL_PIXELFORMAT_BGR888 => Ok(PixelFormatEnum::BGR888),
            ...
            SDL_PIXELFORMAT_ABGR16161616 => Ok(PixelFormatEnum::ABGR16161616),
            SDL_PIXELFORMAT_ABGR16161616F => Ok(PixelFormatEnum::ABGR16161616F),
